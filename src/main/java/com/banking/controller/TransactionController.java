...
public class TransactionController {
	...
	@GetMapping("/{acno}")
	public List<Transaction> list(@PathVariable("acno") int acno){
		return transactionRepository.findTransactions(acno);
	}
	...
	public void IMPSTransfer(@RequestBody BankTransfer bankTransfer) {
		transactionService.IMPSTransfer(bankTransfer);
	}
